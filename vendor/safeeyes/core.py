...
class SafeEyesCore:
    ...
    _break_end_timestamp: typing.Optional[float] = None
    ...
    def __init__(self, context: Context) -> None:
        ...
        self._break_end_timestamp = None
    ...
    def resume_break(
        ...
        self._break_end_timestamp = time.time() + int(duration)
    ...
    def __start_break(self) -> None:
        ...
        self._break_end_timestamp = time.time() + break_obj.duration
    ...
    def __cycle_break_countdown(self) -> None:
        ...
        # GLib timeouts use a clock that stops during suspend. Derive break time
        # from a wall-clock deadline so sleeping or locking the screen satisfies
        # a break, while work timers retain Safe Eyes' normal pause behavior.
        if self._break_end_timestamp is not None:
            self._countdown = max(
                0, math.ceil(self._break_end_timestamp - time.time())
            )
