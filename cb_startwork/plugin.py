...
#     work continue.
#   - Composes with ChickenBlocker's time-left re-impose: a suspend SHORTER than
...
# dialog is already up. The daemon (ChickenBlocker) skips all enforcement while
